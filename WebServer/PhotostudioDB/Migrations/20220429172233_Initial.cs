    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_application_service", x => x.id);
                    table.ForeignKey(
                        name: "FK_application_service_address_address_id",
                        column: x => x.address_id,
                        principalTable: "address",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_application_service_employees_employee_id",
                        column: x => x.employee_id,
                        principalTable: "employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_application_service_hall_hall_id",
                        column: x => x.hall_id,
                        principalTable: "hall",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_application_service_orders_order_id",
                        column: x => x.order_id,
                        principalTable: "orders",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_application_service_rented_items_rented_item_id",
                        column: x => x.rented_item_id,
                        principalTable: "rented_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_application_service_services_service_id",
                        column: x => x.service_id,
                        principalTable: "services",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_application_service_statuses_status_id",
                        column: x => x.status_id,
                        principalTable: "statuses",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_application_service_address_id",
                table: "application_service",
                column: "address_id");

            migrationBuilder.CreateIndex(
                name: "IX_application_service_employee_id",
                table: "application_service",
                column: "employee_id");

            migrationBuilder.CreateIndex(
                name: "IX_application_service_hall_id",
                table: "application_service",
                column: "hall_id");

            migrationBuilder.CreateIndex(
                name: "IX_application_service_order_id",
                table: "application_service",
                column: "order_id");

            migrationBuilder.CreateIndex(
                name: "IX_application_service_rented_item_id",
                table: "application_service",
                column: "rented_item_id");

            migrationBuilder.CreateIndex(
                name: "IX_application_service_service_id",
                table: "application_service",
                column: "service_id");

            migrationBuilder.CreateIndex(
                name: "IX_application_service_status_id",
                table: "application_service",
                column: "status_id");
